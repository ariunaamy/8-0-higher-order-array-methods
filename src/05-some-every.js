...
function allSongsAreOverTwoMinutes(songs) {
  let songOverTwoMinutes = songs.every(song => song.runtimeInSeconds > 120);
  return songOverTwoMinutes;
}
...
function anySongIsOverFourMinutes(songs) {
  let songOverFourMinutes = songs.some(song => song.runtimeInSeconds > 240);
  return songOverFourMinutes;
}
