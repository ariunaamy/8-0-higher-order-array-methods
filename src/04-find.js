...
function findPinkElephantsByTimestreet(songs) {
  pinkElephantSong = songs.find(song => song.title === "Pink Elephants");
  return pinkElephantSong;
}
...
function findFirstSongUnderThreeMinutes(songs) {
  underThreeMinutes = songs.find(song => song.runtimeInSeconds < 180);
...
titleEqualsAlbum = songs.find(song => song.title === song.album);
